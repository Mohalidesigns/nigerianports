                          ...
                          @endif
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <form method="POST" action="{{ route('npas.update', $npa->id) }}"  enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-lg-8">
                                            <div class="mb-3 row">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" name="vregistration" value='{{ $npa->vregistration }}'>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="example-date-input" class="col-sm-4 form-label align-self-center mb-lg-0 text-end">Vehicle Make</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" name="vmake" value='{{ $npa->vmake }}'>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="example-date-input" class="col-sm-4 form-label align-self-center mb-lg-0 text-end">Issue Date</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" data-provide="datepicker" data-date-format="d M, yyyy" id="datepicker" name="idate" value='{{ $npa->idate }}'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text"  data-provide="datepicker" data-date-format="d M, yyyy" id="datepicker" name="edate" value='{{ $npa->edate }}'>
                                                </div>
                                            </div>
